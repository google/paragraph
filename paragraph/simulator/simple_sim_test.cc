...
TEST(SimpleSim, WhileLoop) {
  ...
  std::vector<std::string> test_results = {
    ...
    "1,send_sendstart,send-start,1.000000000000,1.014000000000,"
        "1.024000000000,0.010000000000,0.010000000000",
    "1,reduction_operand1,delay,1.010000000000,1.024000000000,"
        "1.074000000000,0.050000000000,0.050000000000",
    "1,call_func,delay,1.014000000000,1.074000000000,"
        "1.075000000000,0.001000000000,0.001000000000",
    "1,cond_call,call,1.014000000000,1.074000000000,"
        "1.075000000000,0.001000000000,0.001000000000",
    "1,send_senddone,send-done,1.024000000000,1.075000000000,"
        "1.075000000000,0.000000000000,0.000000000000",
    "1,send,send,1.000000000000,1.014000000000,"
        "1.075000000000,0.010000000000,0.061000000000",
    "1,body_compute,delay,1.075000000000,1.075000000000,"
        "1.079000000000,0.004000000000,0.004000000000",
    "1,call_func,delay,1.079000000000,1.079000000000,"
        "1.080000000000,0.001000000000,0.001000000000",
    "1,cond_call,call,1.079000000000,1.079000000000,"
        "1.080000000000,0.001000000000,0.001000000000",
    "1,test,while,1.000000000000,1.010000000000,"
        "1.080000000000,0.010000000000,0.070000000000"
  };
  ...
  EXPECT_DOUBLE_EQ(sim->GetTime(), 1.08);
}
