...
#ifndef PARAGRAPH_SHIM_STATUSOR_H_
#define PARAGRAPH_SHIM_STATUSOR_H_
...
#include "paragraph/shim/statusor_internals.h"
...
#define PARAGRAPH_SHIM_ABSL_MUST_USE_RESULT __attribute__((warn_unused_result))
...
template <typename T>
class PARAGRAPH_SHIM_ABSL_MUST_USE_RESULT StatusOr;
#endif
...
class StatusOr : private internal_statusor::StatusOrData<T>,
 ...
 public:
  ...
  StatusOr(const absl::Status& status);  // NOLINT(runtime/explicit)
  ...
  StatusOr(absl::Status&& status);  // NOLINT(runtime/explicit)
  ...
  // otherwise it fails on abort() if !this->ok().
  //
...
#endif  // PARAGRAPH_SHIM_STATUSOR_H_
