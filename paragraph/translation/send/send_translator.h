 ...
 */
#ifndef PARAGRAPH_TRANSLATION_SEND_SEND_TRANSLATOR_H_
#define PARAGRAPH_TRANSLATION_SEND_SEND_TRANSLATOR_H_
...
class SendTranslator : public Translator {
 public:
  virtual ~SendTranslator() = default;

  // Creates particular Send algorithm based on Json config
  static shim::StatusOr<std::unique_ptr<SendTranslator>>
...
#endif  // PARAGRAPH_TRANSLATION_SEND_SEND_TRANSLATOR_H_
