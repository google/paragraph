 ...
 */
#ifndef PARAGRAPH_TRANSLATION_ALLGATHER_ALLGATHER_TRANSLATOR_H_
#define PARAGRAPH_TRANSLATION_ALLGATHER_ALLGATHER_TRANSLATOR_H_
...
class AllGatherTranslator : public Translator {
 public:
  virtual ~AllGatherTranslator() = default;

  // Creates particular AllGather algorithm based on Json config
  static shim::StatusOr<std::unique_ptr<AllGatherTranslator>>
...
#endif  // PARAGRAPH_TRANSLATION_ALLGATHER_ALLGATHER_TRANSLATOR_H_
