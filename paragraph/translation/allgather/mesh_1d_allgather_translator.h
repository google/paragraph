 ...
 */
#ifndef PARAGRAPH_TRANSLATION_ALLGATHER_MESH_1D_ALLGATHER_TRANSLATOR_H_
#define PARAGRAPH_TRANSLATION_ALLGATHER_MESH_1D_ALLGATHER_TRANSLATOR_H_
...
/* Mesh1dAllGatherTranslator models an all-gather collective on the
 ...
 * The algorithm splits all-gather into N-1 phases, where N is the size of the
 * mesh. Each phase, 1/N-th of data is gathered from the left neighbor
 ...
 */
class Mesh1dAllGatherTranslator : public AllGatherTranslator {
 public:
  explicit Mesh1dAllGatherTranslator(nlohmann::json config);
  ~Mesh1dAllGatherTranslator() = default;
...
#endif  // PARAGRAPH_TRANSLATION_ALLGATHER_MESH_1D_ALLGATHER_TRANSLATOR_H_
