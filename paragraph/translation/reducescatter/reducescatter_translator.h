 ...
 */
#ifndef PARAGRAPH_TRANSLATION_REDUCESCATTER_REDUCESCATTER_TRANSLATOR_H_
#define PARAGRAPH_TRANSLATION_REDUCESCATTER_REDUCESCATTER_TRANSLATOR_H_
...
class ReduceScatterTranslator : public Translator {
 public:
  virtual ~ReduceScatterTranslator() = default;

  // Creates particular Reduce-Scatter algorithm based on Json config
  static shim::StatusOr<std::unique_ptr<ReduceScatterTranslator>>
...
#endif  // PARAGRAPH_TRANSLATION_REDUCESCATTER_REDUCESCATTER_TRANSLATOR_H_
