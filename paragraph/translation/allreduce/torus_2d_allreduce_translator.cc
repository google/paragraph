...
Torus2dAllReduceTranslator::Torus2dAllReduceTranslator(
  ...
  // If we have a barrier in 2D Torus, we need to pass it to both
...
shim::StatusOr<std::unique_ptr<Subroutine>>
    Torus2dAllReduceTranslator::GetSubroutine(
