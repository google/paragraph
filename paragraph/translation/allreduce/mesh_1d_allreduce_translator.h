 ...
 */
#ifndef PARAGRAPH_TRANSLATION_ALLREDUCE_MESH_1D_ALLREDUCE_TRANSLATOR_H_
#define PARAGRAPH_TRANSLATION_ALLREDUCE_MESH_1D_ALLREDUCE_TRANSLATOR_H_
...
/* Mesh1dAllReduceTranslator models an all-reduce collective on the
 * 1D-Mesh topology. This algorithm works with any phisycal
 ...
 */
class Mesh1dAllReduceTranslator : public AllReduceTranslator {
 public:
  explicit Mesh1dAllReduceTranslator(nlohmann::json config);
  ~Mesh1dAllReduceTranslator() = default;
...
#endif  // PARAGRAPH_TRANSLATION_ALLREDUCE_MESH_1D_ALLREDUCE_TRANSLATOR_H_
