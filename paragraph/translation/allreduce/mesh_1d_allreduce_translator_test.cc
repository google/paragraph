...
// Tests expanding 1D-Mesh all-reduce
TEST(Mesh1dAllReduce, NoBarrier) {
...
inner_subroutines {
  name: "all-reduce_mesh-1d"
  subroutine_root_id: 18
  execution_probability: 1
  execution_count: 1
  instructions {
    name: "all-reduce_mesh-1d_reduce-scatter"
    ...
    inner_subroutines {
      name: "all-reduce_mesh-1d_reduce-scatter_mesh-1d"
      subroutine_root_id: 14
      execution_probability: 1
      execution_count: 1
      instructions {
        name: "all-reduce_mesh-1d_reduce-scatter_mesh-1d_ccw_sendrecv_0"
        opcode: "sendrecv"
        instruction_id: 8
        bytes_in: 16
        bytes_out: 16
      ...
      instructions {
        name: "all-reduce_mesh-1d_reduce-scatter_mesh-1d_ccw_reduction_0"
        opcode: "call"
        instruction_id: 9
        operand_ids: 8
        inner_subroutines {
      ...
      instructions {
        name: "all-reduce_mesh-1d_reduce-scatter_mesh-1d_ccw_recv_1"
        opcode: "recv"
        instruction_id: 13
        bytes_in: 16
        communication_groups {
      ...
      instructions {
        name: "all-reduce_mesh-1d_reduce-scatter_mesh-1d_ccw_reduction_1"
        opcode: "call"
        instruction_id: 14
        operand_ids: 13
        inner_subroutines {
  ...
  instructions {
    name: "all-reduce_mesh-1d_all-gather"
    opcode: "all-gather"
    instruction_id: 18
    bytes_out: 48
    communication_groups {
    ...
    operand_ids: 7
    inner_subroutines {
      name: "all-reduce_mesh-1d_all-gather_mesh-1d"
      subroutine_root_id: 20
      execution_probability: 1
      execution_count: 1
      instructions {
        name: "all-reduce_mesh-1d_all-gather_mesh-1d_ccw_sendrecv_0"
        opcode: "sendrecv"
        instruction_id: 19
        bytes_in: 16
        bytes_out: 16
      ...
      instructions {
        name: "all-reduce_mesh-1d_all-gather_mesh-1d_ccw_recv_1"
        opcode: "recv"
        instruction_id: 20
        bytes_in: 16
        communication_groups {
...
// Tests expanding 1D-Mesh all-reduce with barrier
TEST(Mesh1dAllReduce, WithBarrier) {
  auto graph = absl::make_unique<paragraph::Graph>("test_graph", 2);
  auto sub = absl::make_unique<paragraph::Subroutine>(
      "test_subroutine", graph.get());
  auto sub_ptr = sub.get();
...
inner_subroutines {
  ...
  execution_count: 1
  instructions {
    name: "all-reduce_mesh-1d_barrier"
    opcode: "barrier"
    instruction_id: 7
    communication_groups {
      group_ids: 0
    ...
    inner_subroutines {
      name: "all-reduce_mesh-1d_barrier_centralized"
      subroutine_root_id: 9
      execution_probability: 1
      execution_count: 1
      instructions {
        name: "all-reduce_mesh-1d_barrier_centralized_send_to_0"
        opcode: "send"
        instruction_id: 8
        communication_groups {
          group_ids: 0
      ...
      instructions {
        name: "all-reduce_mesh-1d_barrier_centralized_recv_from_0"
        opcode: "recv"
        instruction_id: 9
        communication_groups {
          group_ids: 0
