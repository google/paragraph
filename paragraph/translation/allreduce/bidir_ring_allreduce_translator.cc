...
BiDirRingAllReduceTranslator::BiDirRingAllReduceTranslator(
...
shim::StatusOr<std::unique_ptr<Subroutine>>
    BiDirRingAllReduceTranslator::GetSubroutine(
