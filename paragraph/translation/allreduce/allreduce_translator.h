 ...
 */
#ifndef PARAGRAPH_TRANSLATION_ALLREDUCE_ALLREDUCE_TRANSLATOR_H_
#define PARAGRAPH_TRANSLATION_ALLREDUCE_ALLREDUCE_TRANSLATOR_H_
...
class AllReduceTranslator : public Translator {
 public:
  virtual ~AllReduceTranslator() = default;

  // Creates particular AllReduce algorithm based on Json config
  static shim::StatusOr<std::unique_ptr<AllReduceTranslator>>
...
#endif  // PARAGRAPH_TRANSLATION_ALLREDUCE_ALLREDUCE_TRANSLATOR_H_
