...
UniDirRingAllReduceTranslator::UniDirRingAllReduceTranslator(
...
shim::StatusOr<std::unique_ptr<Subroutine>>
    UniDirRingAllReduceTranslator::GetSubroutine(
