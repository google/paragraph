 ...
 */
#ifndef PARAGRAPH_TRANSLATION_ALLREDUCE_UNIDIR_RING_ALLREDUCE_TRANSLATOR_H_
#define PARAGRAPH_TRANSLATION_ALLREDUCE_UNIDIR_RING_ALLREDUCE_TRANSLATOR_H_
...
/* UniDirRingAllReduceTranslator models an all-reduce collective on the
 ...
 */
class UniDirRingAllReduceTranslator : public AllReduceTranslator {
 public:
  explicit UniDirRingAllReduceTranslator(nlohmann::json config);
  ~UniDirRingAllReduceTranslator() = default;
...
#endif  // PARAGRAPH_TRANSLATION_ALLREDUCE_UNIDIR_RING_ALLREDUCE_TRANSLATOR_H_
